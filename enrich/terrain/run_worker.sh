...
systemd-run --user --unit=enrich-terrain \
  ...
  --setenv=TERRAIN_DSM_PATH_GLO30="${TERRAIN_DSM_PATH_GLO30:-}" \
  --setenv=TERRAIN_DTM_PATH_GLO30="${TERRAIN_DTM_PATH_GLO30:-}" \
  --setenv=TERRAIN_ATTRIBUTION_GLO30="${TERRAIN_ATTRIBUTION_GLO30:-}" \
  --setenv=TERRAIN_DSM_PATH_CUZK="${TERRAIN_DSM_PATH_CUZK:-}" \
  --setenv=TERRAIN_DTM_PATH_CUZK="${TERRAIN_DTM_PATH_CUZK:-}" \
  --setenv=TERRAIN_ATTRIBUTION_CUZK="${TERRAIN_ATTRIBUTION_CUZK:-}" \
